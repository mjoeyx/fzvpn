...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To FZVPN Tunneling ${YELLOW}(${NC}${green} Stable Version ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Author : ${green}® ${NC}${YELLOW}(${NC} ${green} FZVPN Tunneling ${NC}${YELLOW})${NC}"
echo -e " © Recode By MJC${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/rifstore/vip/main/"
...
wget raw.githubusercontent.com/rifstore/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
